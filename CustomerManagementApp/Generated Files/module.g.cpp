...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"CustomerManagementApp.XamlMetaDataProvider"))
    {
        return winrt::detach_abi(winrt::make<winrt::CustomerManagementApp::factory_implementation::XamlMetaDataProvider>());
    }
