...
namespace winrt::CustomerManagementApp::implementation
{
    ...
    struct DashboardT : public ::winrt::CustomerManagementApp::implementation::Dashboard_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename DashboardT::base_type;
        using base_type::base_type;
        using class_type = typename DashboardT::class_type;
    ...
    private:
        struct Dashboard_obj1_Bindings;
