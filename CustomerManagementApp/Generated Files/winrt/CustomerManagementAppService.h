...
{
    inline AuthUserResultVM::AuthUserResultVM() :
        AuthUserResultVM(impl::call_factory_cast<AuthUserResultVM(*)(winrt::Windows::Foundation::IActivationFactory const&), AuthUserResultVM>([](winrt::Windows::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<AuthUserResultVM>(); }))
    {
    }
    inline User::User() :
        User(impl::call_factory_cast<User(*)(winrt::Windows::Foundation::IActivationFactory const&), User>([](winrt::Windows::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<User>(); }))
    {
    }
    inline User::User(int32_t id, param::hstring const& username, param::hstring const& password, int64_t companyId) :
        User(impl::call_factory<User, IUserFactory>([&](IUserFactory const& f) { return f.CreateInstance(id, username, password, companyId); }))
    {
    }
    inline UserService::UserService() :
        UserService(impl::call_factory_cast<UserService(*)(winrt::Windows::Foundation::IActivationFactory const&), UserService>([](winrt::Windows::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<UserService>(); }))
    {
    }
}
namespace std
