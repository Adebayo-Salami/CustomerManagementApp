...
#pragma once
#include "winrt/CustomerManagementApp.h"
#include "winrt/Windows.UI.Xaml.Markup.h"
namespace winrt::CustomerManagementApp::implementation
{
    template <typename D, typename... I>
    struct __declspec(empty_bases) XamlMetaDataProvider_base : implements<D, CustomerManagementApp::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = CustomerManagementApp::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"CustomerManagementApp.XamlMetaDataProvider";
        }
    };
}
namespace winrt::CustomerManagementApp::factory_implementation
{
    template <typename D, typename T, typename... I>
    struct __declspec(empty_bases) XamlMetaDataProviderT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = CustomerManagementApp::XamlMetaDataProvider;
